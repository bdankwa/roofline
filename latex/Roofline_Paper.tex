...
\title{Extending the Roofline Model for Supercomputers}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Boakye Dankwa, Fengguang Song}
...
TODO , \cite{expPerfmOnHHS}, \cite{rooflineMatMdel},\cite{applyRoofline}
%\hfill mds
...
\section{Proposed 3-D Roofline Model} \label{contribution}
Create 2-D model - (peak performance of multicore, memory bandwith using STREAM, operational intensity of kernels)

Create 3-D model - (peak performance of multicore, memory bandwith using STREAM, operational intensity of kernels, communication intensity)

\subsection{Peak Network Throughput}
TODO
